...
using MyFlix.DAO.IService;
using MyFlix.DAO.Models;
using MyFlix.DAO.Service;
using MyFlix.DAO.Service.Token;
using MyFlix.Util;
...
builder.Services.AddScoped<IServiceFilme, ServiceFilme>();
...
builder.Services.AddScoped<IRepositoryFilme, RepositoryFilme>();
#endregion
...
builder.Services.AddDbContext<MyFlixDbContext>(options =>
    options.UseSqlServer(connectionString));
builder.Services.AddDatabaseDeveloperPageExceptionFilter();

builder.Services.AddDefaultIdentity<IdentityUser>()
    .AddRoles<IdentityRole>()
    .AddEntityFrameworkStores<MyFlixDbContext>();
...
app.UseSwagger();
app.UseSwaggerUI(c =>
c.SwaggerEndpoint("/swagger/v.1.0/swagger.json", "MyFlix.API"));
